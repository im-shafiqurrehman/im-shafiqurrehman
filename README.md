...
**Cloud & DevOps Engineer | Backend | AI**
...
[Portfolio](https://shafiqurrehman.com) · [LinkedIn](https://www.linkedin.com/in/im-shafiqurrehman/) · [Dev.to](https://dev.to/im-shafiqurehman) · [LeetCode](https://leetcode.com/u/im-shafiqurrehman/) · [Email](mailto:shafiqurrehmanbscs2022@gmail.com)
...
`Python` `FastAPI` `Docker` `GitHub Actions` `AWS EC2` `MLflow` `pytest`

### DSA Trainer & Mentor · Dev Weekends Fellowship · May 2025 to Present · Remote
...
### AI Engineer & LLM Trainer · Turing · Oct 2025 to Mar 2026 · Contract · Remote
...
### Software Engineer Intern · Stem Solutions · Jun to Aug 2025 · Lahore
Cross-platform mobile development for a production app.

- Shipped 12 production screens for Android and iOS in React Native and TypeScript
- Built a reusable component library and cut initial screen load time by 25% through render optimization
- Worked from Figma designs in an agile team using Git and GitLab

`React Native` `TypeScript` `Figma` `GitLab`
...
[See all projects](https://shafiqurrehman.com)

---

## Writing & Speaking

Long-form technical writing on AI systems and web internals. Full list at
[dev.to/im-shafiqurehman](https://dev.to/im-shafiqurehman).
...
**Cloud & DevOps.** AWS (EC2, S3, IAM) · Docker · GitHub Actions · CI/CD pipeline design · Nginx · Linux · Vercel

**Backend.** Node.js · Express · FastAPI · REST APIs · Microservices · Redis · JWT / OAuth 2.0

**Frontend & Mobile.** React · Next.js · React Native · TypeScript · Redux Toolkit / RTK Query · Tailwind CSS

**Data.** MongoDB · PostgreSQL · MySQL · Redis · SQLite · Firebase

**AI & ML.** LLM training and evaluation · RLHF · RAG · LangChain / LangGraph · MCP agents · OpenAI API · QLoRA · XGBoost · MLflow

**Languages.** Python · C++ · JavaScript · TypeScript · SQL

**Learning now.** Kubernetes · Terraform · Helm · Prometheus / Grafana · Kafka

---

## Education & Certifications

**BS Computer Science** · University of Education, Lahore · 2022 to 2026

- Microservices with Node.js and React: event-driven architecture, Docker, Kubernetes, CI/CD (2026)
- AI Engineer Core Track: LLM engineering, RAG, QLoRA fine-tuning (2026)
- AI Engineer Agentic Track: agents and Model Context Protocol (2026)
- Honorable Mention, ICPC Asia Topi Online Preliminary Contest (2024)
- Bronze Fellowship Award, Dev Weekends (2025)
